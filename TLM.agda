...
open import Data.List.Relation.Unary.All using (All ; lookup ; _[_]≔_)
...
open import Data.Vec.Relation.Unary.All using () renaming (All to Allv ; lookup to lookupv)
...
run-step (suc f) p r block-halt = just r
